...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSDate *expiresDate = self.userDefaultsManager.expiresIn;
    ...
    if ([now compare:expiresDate] == NSOrderedAscending) {
        ...
        UIViewController *viewController = [storyboard instantiateViewControllerWithIdentifier:@"newsfeedNavController"];
